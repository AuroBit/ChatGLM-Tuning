...
def main():
    ...
    parser.add_argument("--jsonl_path", type=str, default="../data/chatglm-tuning/sens-chat-single-all.jsonl")
    parser.add_argument("--save_path", type=str, default="../data/chatglm-tuning/sens-chat-single-all")
